...
number = 0
dataset_X = np.zeros((811,224,224,3))####5167####363
dataset_Y = np.zeros((811,4))
#dataval_X = np.zeros((448,224,224,3))
#dataval_Y = np.zeros((448,4))
dataval_X = np.zeros((378,224,224,3))
dataval_Y = np.zeros((378,4))
print(dataset_Y[0])
...
data_load_image("data/train/borsh2", 0, 1)
data_load_image("data/train/chai2", 1, 1)
data_load_image("data/train/kofe2", 2, 1)
data_load_image("data/train/pel2", 3, 1)
#number = 0
data_load_image("data/val/borsh1", 0, 1)
data_load_image("data/val/chai", 1, 1)
data_load_image("data/val/kofe", 2, 1)
data_load_image("data/val/pel", 3, 1)

dataset_X, dataset_Y = unison_shuffled_copies(dataset_X,dataset_Y)
#dataval_X, datavalt_Y = unison_shuffled_copies(dataval_X,dataval_Y)
# compile the model 
